...
void UnityAssertEqualMemory(UNITY_INTERNAL_PTR expected,
                            ...
                            const UNITY_FLAGS_T flags)
{
    UNITY_PTR_ATTRIBUTE const uint8_t* ptr_exp = (UNITY_PTR_ATTRIBUTE const uint8_t*)expected;
    UNITY_PTR_ATTRIBUTE const uint8_t* ptr_act = (UNITY_PTR_ATTRIBUTE const uint8_t*)actual;
    UNITY_UINT32 elements = num_elements;
    UNITY_UINT32 bytes;
    ...
    while (elements--)
    {
        ...
        {
            ptr_exp = (UNITY_PTR_ATTRIBUTE const uint8_t*)expected;
        }
    }
}
